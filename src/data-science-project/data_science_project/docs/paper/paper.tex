...
Data science has become a pivotal field in extracting actionable insights from vast amounts of data. In this study, we focus on a comprehensive approach to data analysis and model development, using a dataset sourced from Kaggle, supplemented by additional variables obtained through web scraping. This project aims to build predictive models to extract meaningful patterns and provide reliable predictions based on the integrated dataset.

The data was augmented with biweekly inflation rates and consumer confidence indices from an API, spanning the period from March 31st to June 1st, 2016. This augmentation was intended to enhance the dataset's robustness and provide additional context to the predictive models.

We embarked on this project with the following objectives:

Gather and preprocess the data to ensure quality and consistency.
Perform exploratory data analysis to uncover underlying patterns and relationships.
Engineer features that enhance the predictive power of the models.
Select and train multiple machine learning models to identify the most effective one.
Evaluate the models' performance and derive insights from the results.
