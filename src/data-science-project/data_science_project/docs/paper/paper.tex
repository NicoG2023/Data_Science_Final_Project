...
\begin{itemize}
        ...
        \begin{itemize}
                \item $\textbf{Parameters}$: $n\_estimators=100$, \\$max\_depth=8$, $learning\_rate=0.1$, $subsample=0.8$, $colsample\_bytree=0.8$, $random\_state=42$.
        \end{itemize}
        \item Random Forest: An ensemble learning method using multiple decision trees.
        \begin{itemize}
                \item $\textbf{Parameters}$: $n\_estimators=100$, \\$max\_depth=10$, $random\_state=42$.
        \end{itemize}
\end{itemize}
